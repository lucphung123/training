...
`,[u("input, textarea",`
 ...
 `),A("&:-webkit-autofill ~",[u("placeholder","display: none;")])]),$("round",[q("textarea","border-radius: calc(var(--n-height) / 2);")]),u("placeholder",`
 pointer-events: none;
 position: absolute;
 left: 0;
 right: 0;
 ...
 `)]),$("textarea",[u("placeholder","overflow: visible;")]),q("autosize","width: 100%;"),$("autosize",[u("textarea-el, input-el",`
 position: absolute;
 top: 0;
 left: 0;
 height: 100%;
 ...
 `),["warning","error"].map(r=>$(`${r}-status`,[q("disabled",[m("base-loading",`
